...
/****************************************/
Tree::Tree(GLuint program, Player* camera)
{
	Tree::camera = camera;
...
void Trunk::setCamera(Player* camera)
{
	Trunk::camera = camera;
}
...
void Trunk::setParameter(GLuint programID, Player* camera)
{
	program = programID;
	Trunk::camera = camera;
...
void Leaf::setCamera(Player* camera)
{
	Leaf::camera = camera;
}
...
void Leaf::setParameter(GLuint programID, Player* camera)
{
	program = programID;
	Leaf::camera = camera;
...
void Particles::setParameters(GLuint programID, Player* camera) 
{
